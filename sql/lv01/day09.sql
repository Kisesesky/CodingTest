...
-- chocolate, melon, white_chocolate, strawberry, mango, orange, pineapple, vanilla, 
-- caramel, peach, watermelon, mint_chocolate 순서대로 조회되어야 합니다. 따라서 SQL문을 실행하면 다음과 같이 나와야 합니다.
