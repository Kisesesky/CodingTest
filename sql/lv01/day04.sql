...
-- 풀이
-- DATE_FORMAT(start_date, '%Y-%m') = '2022-09' 대여 시작일이 2022년 9월인 기록 필터
-- DATEDIFF(end_date, start_date) 종료일과 시작일의 일수 차이 계산
-- IF(... >= 30, '장기 대여', '단기 대여') 30일 이상이면 '장기 대여', 아니면 '단기 대여'
-- ORDER BY history_id DESC HISTORY_ID 기준 내림차순 정렬
